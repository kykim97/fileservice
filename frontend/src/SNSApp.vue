...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '파일', 
                description: '사용자가 업로드하는 파일을 나타냅니다.', 
                key: 'files', 
                route: '/drives/files',
                ImageUrl: '',
            },
            { 
                title: '파일 인덱스', 
                description: '파일 위치를 파일 이름으로 인덱싱합니다.', 
                key: 'fileIndices', 
            ...
            { 
                title: '비디오', 
                description: '비디오 파일을 처리하는 서비스입니다.', 
                key: 'videos', 
            ...
            { 
                title: '알림', 
                description: '파일 업로드와 비디오 생성 시 사용자에게 알림을 전송합니다.', 
                key: 'notifications', 
            ...
            { 
                title: '대시보드', 
                description: '업로드 시킨 파일의 상태를 표시합니다.', 
                key: 'dashboards', 
